...
class Grade {
    ...
    #grade
    #honors
    constructor(name,credits,grade,date,honors) {
        this.#name = name;
...
let c = new GradeBook(180)
c.register(new Grade('LAB1', 12, 30, '2026-02-02',true))
c.register(new Grade('PROGALGO', 15, 30, '2026-02-02',false))
c.register(new Grade('ANALISI', 12, 27, '2026-02-02',false))

console.log(c.exportJSON('log.txt'))