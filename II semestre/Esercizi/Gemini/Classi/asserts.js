...
let storico = [...gestore.storico()];
assert.strictEqual(storico.length, 4, "Test 9 Fallito: Lunghezza storico errata");
assert.strictEqual(storico[0].codice, "BB002", "Test 9 Fallito: Ordine storico errato");

// 10. Indipendenza dello storico
storico[0] = null; // Modifica l'array generato
